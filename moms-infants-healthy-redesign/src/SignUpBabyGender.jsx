...
export default class SignUpBabyGender extends React.Component {
  ...
  onPress = () => {
    this.props.setUserInfo({
      babyGender: {
        male: this.state.babyGender.male,
        female: this.state.babyGender.female,
      },
    });
  ...
  render() {
    let genderSelected =
      this.state.babyGender.male || this.state.babyGender.female;
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <View
          style={{ ...appStyles.container, backgroundColor: backgroundColor }}
        >
          <View
            style={{
          ...
          >
            ...
            >
              {this.props.getLocalizedText("selectGenders")}
            </Text>
            <View style={appStyles.rowContainer}>
              <MultipleChoiceButton
                text={"♂"}
                color={appStyles.blueColor}
                selected={this.state.babyGender.male}
                onPress={() => this.setBabyGender("male")}
              />
              <MultipleChoiceButton
                text={"♀"}
                color={appStyles.pinkColor}
                selected={this.state.babyGender.female}
                onPress={() => this.setBabyGender("female")}
              />
            </View>
          </View>
          <View
          ...
          >
            <Button
              text={
                this.state.babyGender.male || this.state.babyGender.female
                  ? this.props.getLocalizedText("continueButton")
                  : this.props.getLocalizedText("iDontKnowButton")
              }
